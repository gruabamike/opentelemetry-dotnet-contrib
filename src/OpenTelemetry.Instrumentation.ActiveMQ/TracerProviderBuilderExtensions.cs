...
{
    /// <summary>
    /// Enables MessageBroker.ActiveMQ.AutoInstrumentation instrumentation.
    /// </summary>
    /// <param name="builder"><see cref="TracerProviderBuilder"/> being configured.</param>
    /// <param name="configureActiveMQInstrumentationOptions">ActiveMQ configuration options.</param>
